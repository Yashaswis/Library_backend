...
public class LibraryController {
	...
	public ResponseEntity<Books> getBooksbyId(@PathVariable(value = "bookId") int bookId)
	...
	public ResponseEntity<Books> updateBooks(@PathVariable("bookId") int bookId, @Valid @RequestBody Books book)
			throws ResourceNotFoundException {
